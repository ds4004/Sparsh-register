        ...
        <>
            ...
            <div id="part-2">
                ...
                <form name="Form" id="part-1">
                    <fieldset>
                        ...
                        <div className="flex-container">
                            <div className='flex-2'>
                                ...
                                <div>
                                    <input type="text" name="tname" placeholder="Eg. Smashers" className="in"/>
                                </div>
                            </div>
                            ...
                            <div className='flex-2'>
                                ...
                                <div>
                                    <input type="text" name="name" placeholder="Eg. Ram Verma" className="in"/>
                                </div>
                            </div>
                            <div className='flex-2'>
                                <div>
                                ...
                                <div>
                                    <input type="tel" name="num" placeholder="Eg. 1234567890" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" className="in"/>
                                </div>
                            </div>
                            <div className='flex-2'>
                                <div>
                            ...
                            <div className='flex-2'>
                                ...
                                <div>
                                    <input type="text" name="mail" placeholder="Eg. u20cs004@coed.svnit.ac.in" className="in" />
                                </div>
                            </div>
                            <div className='flex-2'>
                                <div>
                                ...
                                <div>
                                    <input type="text" name="iname" placeholder="Eg. SVNIT" className="in" />
                                </div>
                            </div>
                            {/* <div className='flex-2'>
                                <div>
                            ...
                            <div className='flex-2'>
                                ...
                                <div>
                                    <input type="radio" name="gender" id="Male" value="Male" className="in"/>
                                    <label htmlFor="Male"> Male </label>

                                    <input type="radio" name="gender" id="Female" value="Female" className="in"/>
                    ...
                    <div id="imp">
                        <ul>
                            <li><p>It is mandatory that all team members bring their College ID Card for verification at the event.</p></li>
                            <li><p>SVNIT Students are requested to kindly use their college email id for registeration.</p></li>
                        </ul>
                    </div>                    
